...
/**
 * Preload fixture for #3808 review round 3 (Major 2) — pin the SPAWNED
 * context-monitor hook's `Date.now()` to `GSD_TEST_NOW_MS`, so the
 * STALE_SECONDS boundary can be driven at exactly limit-1 / limit / limit+1.
 *
