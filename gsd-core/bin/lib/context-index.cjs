...
/**
 * context-index.cjs — generated by scripts/gen-context-index.cjs
 * DO NOT EDIT BY HAND. Run: node scripts/gen-context-index.cjs --write
 * ADR-1671 — Dynamic context management platform, predicate fact-store index.
 * Deterministic index of every `CLASS.subkey=value` predicate declared in
 * the repo-root CONTEXT.md. See src/context-predicates.cts.
 */
